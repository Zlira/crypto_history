...
<article>
  ...
  <p className="main-text">
    ...
    Щоби підбрати ключа простим перебором, не вистачить і часу від початку Всесвіту.
  ...
  <p className="main-text">
    ...
    досілдники зрозуміли, що розподіл частоти букв завжди зберігається більш-менш однаковим.
    Один із вчених, полімат Аль-Кінді, здогадався використати цей факт,
    аби знаходити ключі до зашифрованих повідомлень.
    Свій метод, який ми звемо <em>частотним криптоаналізом</em>,
    він описав у книжці «Манускрипт про дефшифрування криптографічних листів».
  </p>
  <p className="main-text">
  ...
  <p className="main-text">
    Спробуймо зламати одноалфавітний шифр укараїнською мовою. Сам зашифрований текст&nbsp;— у
  ...
  <div className="main-text">
    У підраxунку ми опустили всі символи, які не треба буде розшифровувати&nbsp;— розділові знаки, пробіли і
    таке інше. Стовпці над кожною літерою показують, скільки відсотків тексту вона займає. Ти можеш навести
    мишкою на стовпець і побачити конкертну цифру, але нас більше цікавлять загальні закономірності. Наприклад,
  ...
  <div className="command">
    <p className="command__phrase">
      ...
      зустрічається. Нижній (блакитний) рядок покзаує поширення символів у тексті-зразку.
      ...
      шифротекст зміняться на Б. Якщо тобі схочеться переставити букву Б в інше місце, спрешу
