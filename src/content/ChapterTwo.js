...
<article>
  ...
  <p className="main-text">
    Щоб зламати шифр у кінці сторінки, почнемо із оцінки частоти букв в українській мові.
    Граною ідеєю буде використати як зразок сам цей розділ.
    Адже, якщо є така можливість, то найліпше вибирати текст того ж автора,
    на ту ж тему, що й зашифроване повідомлення.
    Щоб тобі не довелося годинами сліпати над цими буквами, ось таблиця з уже підрахованими символами.
  </p>
  <div className="command">
  ...
  <div className="main-text">
    У підраxунку ми опустили усі символи, які не треба буде розшифровувати&nbsp;— розділові знаки, пробіли і
    ...
    шифротексту нижче. Веред до наступного рівня криптоаналітичних вмінь!
