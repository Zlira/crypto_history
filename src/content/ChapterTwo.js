...
import MonoInstruction from '../img/mono_widget_instruction.gif'
...
<article>
  ...
  <p className="main-text">
    ...
    дипломатичну посаду і стала першою жінкою послом в історії Європи.

    Ще за два роки вона дочекалася шлюбу зі своїм нареченим, який зійшов на престол як король
    Генріх VIII.
    Королева Катерина продовжувала використовувати свій шифр, щоби бути таємною посередницею у спілкуванні
  ...
  <div className="main-text">
    ...
    видно, що найпоширеніші&nbsp;— три голосні (О, А, И), вони не сильно відрізняються між собою за частотою, але
  ...
  <div className="command">
    <p className="command__phrase">
      ...
      ти можеш клацати мишкою на будь-яку з букв, щоб побачити, де саме в тексті вона
      зустрічається. Нижній (блакитний) рядок показує поширення символів у тексті-зразку.
      Букви цього блоку можна перетягувати мишкою з місця на місце.
      <img src={MonoInstruction} width={600} alt="gif інструкція використання віджета злому"/>
      <br/>Наприклад, якщо ти підозрюєш,
      ...
      шифротексті зміняться на Б. Якщо ти передумаєш і вирішиш, що парою до $ є, скажімо, Щ,
      слід спершу «відчепити» Б, клацнувши на смужці, яка сполучає її з верхнім рядком, а тоді
      вже перетягувати Щ на це місце.
